...
LIs $\rightarrow$ LIs \underline{NXT} \underline{VAR} \underline{ASIG} EXP
...
\begin{table}[htbp]
	\centering
		\begin{tabular}{|c|c|}
			...
			LIs $\rightarrow$ LIs \underline{NXT} \underline{VAR} \underline{ASIG} EXP & \textbf{lis}: LIs X String X EXP $\rightarrow$ LIs \\ \hline
