...
public class AnalizadorLexicoJLex implements java_cup.runtime.Scanner{
	...
	public AnalizadorLexicoJLex (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	AnalizadorLexicoJLex (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
